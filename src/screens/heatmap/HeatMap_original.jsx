...
import {  fetchHeatMapTheme, selectApplicationTheme, selectHeatMapTheme } from "../../redux/slice/theme/themeSlice";
...
const HeatMap = () => {
  ...
  // Only fetch if status is 'idle' (not yet fetched) or 'failed' (needs retry)
  // This prevents multiple calls when floors array is empty but fetch was successful
  useEffect(() => {
    // if (floorStatus === 'idle' || (floorStatus === 'failed' && (!floors || floors.length === 0))) {
      ...
      >
        ...
        >
          ...
          <Box
            sx={{
              ...
              height: '90%', // Reduced from 100% to 75%
              display: 'flex',
              flexDirection: 'row',
              alignItems: 'center',
              justifyContent: 'center',
          ...
          >
            ...
            >
              ...
              <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                ...
                >
                  {displayMode === 'Energy' ? 'Savings:' : `${displayMode}:`}
                </Typography>
                {displayMode === 'Light' && (
        ...
        {selectedAreaId && (
          ...
          >
            ...
            {/* Main Content - Scrollable area for all data */}
            <Box sx={{
              flex: 1,
              display: 'flex',
              flexDirection: 'column',
