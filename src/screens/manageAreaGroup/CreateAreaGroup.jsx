...
const CreateAreaGroup = () => {
    ...
    const handleAddFromDialog = ({ areaNames, areaCodes, areaIds, floorId, floorName }) => {
        ...
        console.log('Adding areas to location:', { floorId: numericFloorId, floorName, areaCount: validAreaIds.length });
        ...
        setLocations(prev => {
            ...
            if (existingLocationIndex >= 0) {
                ...
                console.log('Merged location:', updated[existingLocationIndex]);
                return updated;
            } else {
                // Add new location
                const newLocation = { 
